...
#' 
#' @examples 
#' # transform raw-data into cosdata:
#' raw_data <- viscos_example()
#' head(raw_data)
#' 
#' cos_data <- cook_cosdata(raw_data)
#' head(cos_data)
#' 
...
#'
#' @param cosdata A raw cosdata data.frame, which may contains basins without observations. \strong{Note:} It is assumed that all available basins are simulated!
