...
cook_cosdata <- function(raw_data, info = NULL) {
  ...
  #'
  #' @export
  mark_periods <- function(cos_data, start_month = 10L, end_month = 9L) {
    # pre: ====================================================================
