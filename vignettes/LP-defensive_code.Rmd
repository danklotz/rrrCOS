...
## `assert_chunk`
This function tests if there are any columns in the data.frame `cos_data`,
...
`cos_data` are set to lower cases with `tolower`.
```{r}
#' @import magrittr
...
existent in `cos_data`. This is done by checking if the names of the
