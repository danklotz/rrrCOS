...
visCOS provides a set of global options for controling the package. They are 
implemented with the help of the `GlobalOptions` package. This section 
defines the code the code for the global options and explains the 
individual options:
```{r}
