...
# Overview 
This chapter defines code of the **visCOS** functions used for "cooking data".
...
In this chapter the following functions are defined: 
...
There is one problem with that solution, namely if `start_month` > `end_month`, 
then the last year cannot be extracted with that simply method. Thus, 
