...
The body of `remove_chunk` works as following: First, the names of the columns of
the runoff_data are determined via `names` and all set to lower letters with
