...
## `set_panel_size`
Klotz: I honestly forgot what this function does! #§ 
I need to look it up, but am not ready yet! I roughly remember that setting 
grapfical options with ggplot is a mess, and this is a function, which 
migh toslve a lot. However, I am not sure! 
```{r}
