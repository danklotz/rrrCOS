...
Before starting we need some example data. We can take a look at example1.rmd to see how the *pour_* functions work in more detail. For now, let us just get the data, take a short look at it and move on.
```{r}
...
###*prepare_*periods
The function `prepare_periods` is used to mark the periods of interest. In hydrological application within Europe one might be interested to mark the hydrological years (September to August) as such a period. One can do this by... 
```{r}
